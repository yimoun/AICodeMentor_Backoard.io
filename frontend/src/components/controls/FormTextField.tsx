import { type UseFormRegisterReturn } from "react-hook-form";  //Type fourni par react-hook-form, utilisé pour lier un champ de formulaire à la gestion du formulaire.
